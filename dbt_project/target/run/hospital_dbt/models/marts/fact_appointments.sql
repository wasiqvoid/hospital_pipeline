  ...
  create  table "neondb"."public_marts"."fact_appointments__dbt_tmp"
...
with appointments as (
    select * from "neondb"."public_staging"."stg_appointments"
),

treatments as (
    select * from "neondb"."public_staging"."stg_treatments"
),

billing as (
    select * from "neondb"."public_staging"."stg_billing"
)
